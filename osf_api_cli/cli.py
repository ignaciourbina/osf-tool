...
def cmd_draft(client: OSFClient, args: argparse.Namespace) -> None:
    draft = client.get_draft_registration(args.draft_id)
    if args.output:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_draft = sub.add_parser("draft", help="Show a specific draft registration")
    p_draft.add_argument("draft_id", help="Draft registration ID")
    p_draft.add_argument("-o", "--output", help="Write JSON to file path")
